...
DEFAULT_VERSION_CHROME = '138.0.0.0'  # While the actual version has minor/rev/etc values, the user agent uses 0s
DEFAULT_VERSION_FIREFOX = '139.0'  # While the actual version has a micro value, the user agent does not include it
